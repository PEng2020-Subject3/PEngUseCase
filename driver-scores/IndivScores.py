...
class IndivScores(object):
	...
	def getDriverscoreData(self):
		self.speedscore = 0.3#self.getSpeedVal()
		self.turnscore = 0.6#self.getTurnVal()
		self.brakescore = 0.67#self.getBrakeVal()
		self.crashscore = 0.9#self.getCrashVal()
		self.avgspeed = 33#self.getAvgSpeed()
